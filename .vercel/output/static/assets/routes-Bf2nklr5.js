...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ba(e,t,n){return new li({name:`SphericalGaussianBlur`,defines:{SAMPLES:Ta,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:Ua(),fragmentShader:`
	...
	`}var Wa=class extends Ft{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Jr(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var gs={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function _s(e,t){let n=gs[t];return n===void 0?(V(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var vs=new G;function ys(){return q.getLuminanceCoefficients(vs),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${vs.x.toFixed(4)}, ${vs.y.toFixed(4)}, ${vs.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`,Fc=.15,Ic=[{id:`base`,label:`Base`,freq:`steady`,color:`#4a88c4`},{id:`violet`,label:`Violet`,freq:`sin(t)`,color:`#a85ad6`},{id:`life`,label:`Life`,freq:`7.83 Hz`,color:`#3dcc7a`},{id:`gold`,label:`Gold`,freq:`φ 1.618`,color:`#e8c547`},{id:`field`,label:`Field`,freq:`envelope`,color:`#6fd4a8`}],Lc={bloom:.82,threshold:.48,parallax:.78,pipeline:!0},Rc=[{id:`sovereign`,label:`Sovereign`,src:`/art/sovereign.png`},{id:`field`,label:`Mandala`,src:`/art/mandala.jpg`}];function zc(e,t,n){return new Ft(e,t,{minFilter:h,magFilter:h,format:M,type:n,depthBuffer:!1,stencilBuffer:!1})}var Bc=class{renderer;camera;rtScene;quad;sceneMat;lumMat;blurHMat;blurVMat;compMat;fboSource;fboBright;fboBlurH;fboBlurV;textures=new Map;loader=new Ri;params={...Lc};sceneId=`sovereign`;motion=.5;depth=.52;lastT=0;fps=60;fpsAccum=0;fpsFrames=0;disposed=!1;onStats;statsClock=0;resizeObs;constructor({canvas:e,onStats:t}){this.onStats=t,this.renderer=new kc({canvas:e,antialias:!1,alpha:!1,powerPreference:`high-performance`}),this.renderer.setClearColor(328970,1),this.renderer.outputColorSpace=We,this.renderer.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),this.camera=new qi(-1,1,1,-1,0,1);let n=new ei(2,2),r=this.renderer.capabilities.isWebGL2?T:v,i=Math.max(1,e.clientWidth||1),a=Math.max(1,e.clientHeight||1);this.fboSource=zc(i,a,r),this.fboBright=zc(i,a,r),this.fboBlurH=zc(i,a,r),this.fboBlurV=zc(i,a,r),this.sceneMat=new li({vertexShader:Ac,fragmentShader:jc,uniforms:{tArt:{value:null},uResolution:{value:new W(i,a)},uTexSize:{value:new W(1,1)},uTime:{value:0},uMotion:{value:.5},uDepth:{value:.5},uParallax:{value:this.params.parallax},uMode:{value:0}},depthTest:!1,depthWrite:!1}),this.lumMat=new li({vertexShader:Ac,fragmentShader:Mc,uniforms:{tSource:{value:null},uThreshold:{value:this.params.threshold}},depthTest:!1,depthWrite:!1}),this.blurHMat=new li({vertexShader:Ac,fragmentShader:Nc,uniforms:{tGlow:{value:null},uResolution:{value:new W(i,a)},uDirection:{value:new W(1,0)}},depthTest:!1,depthWrite:!1}),this.blurVMat=new li({vertexShader:Ac,fragmentShader:Nc,uniforms:{tGlow:{value:null},uResolution:{value:new W(i,a)},uDirection:{value:new W(0,1)}},depthTest:!1,depthWrite:!1}),this.compMat=new li({vertexShader:Ac,fragmentShader:Pc,uniforms:{tScene:{value:null},tGlow:{value:null},uTime:{value:0},uBloom:{value:this.params.bloom},uPipeline:{value:1}},depthTest:!1,depthWrite:!1}),this.quad=new Br(n,this.sceneMat),this.rtScene=new Sn,this.rtScene.add(this.quad);let o=this.makeFallback();this.bindTexture(o),this.resize(),this.resizeObs=new ResizeObserver(()=>this.resize()),this.resizeObs.observe(e.parentElement??e),this.preload(`sovereign`,`/art/sovereign.png`),this.preload(`field`,`/art/mandala.jpg`),this.renderer.setAnimationLoop(this.loop)}setScene(e){this.sceneId=e,this.sceneMat.uniforms.uMode.value=+(e===`field`);let t=this.textures.get(e);t&&this.bindTexture(t)}setParams(e){this.params={...this.params,...e},this.lumMat.uniforms.uThreshold.value=this.params.threshold,this.compMat.uniforms.uBloom.value=this.params.bloom,this.compMat.uniforms.uPipeline.value=+!!this.params.pipeline,this.sceneMat.uniforms.uParallax.value=this.params.parallax}setMotion(e,t){this.motion=e,this.depth=t}dispose(){this.disposed||(this.disposed=!0,this.renderer.setAnimationLoop(null),this.resizeObs.disconnect(),this.quad.geometry.dispose(),this.sceneMat.dispose(),this.lumMat.dispose(),this.blurHMat.dispose(),this.blurVMat.dispose(),this.compMat.dispose(),this.fboSource.dispose(),this.fboBright.dispose(),this.fboBlurH.dispose(),this.fboBlurV.dispose(),this.textures.forEach(e=>e.dispose()),this.renderer.dispose())}preload(e,t){this.loader.load(t,t=>{t.minFilter=h,t.magFilter=h,t.generateMipmaps=!1,t.colorSpace=We,this.textures.set(e,t),this.sceneId===e&&this.bindTexture(t)},void 0,()=>{let t=this.makeFallback();this.textures.set(e,t),this.sceneId===e&&this.bindTexture(t)})}bindTexture(e){this.sceneMat.uniforms.tArt.value=e;let t=e.image,n=t?.width??1,r=t?.height??1;this.sceneMat.uniforms.uTexSize.value.set(n,r)}makeFallback(){let e=document.createElement(`canvas`);e.width=1024,e.height=1024;let t=e.getContext(`2d`);if(t){let e=t.createRadialGradient(512,512,0,512,512,512);e.addColorStop(0,`#ffd700`),e.addColorStop(.22,`#7dff9a`),e.addColorStop(.45,`#40c0ff`),e.addColorStop(.7,`#8040ff`),e.addColorStop(1,`#05050a`),t.fillStyle=e,t.fillRect(0,0,1024,1024);for(let e=0;e<5;e++){let n=e/5*Math.PI*2-Math.PI/2;t.beginPath(),t.moveTo(512,512),t.lineTo(512+Math.cos(n)*500,512+Math.sin(n)*500),t.strokeStyle=`rgba(255,255,255,0.85)`,t.lineWidth=8,t.stroke()}}let n=new Yr(e);return n.colorSpace=We,n}resize=()=>{if(this.disposed)return;let e=this.renderer.domElement,t=e.parentElement??e,n=Math.max(1,t.clientWidth),r=Math.max(1,t.clientHeight),i=Math.min(window.devicePixelRatio||1,2);this.renderer.setPixelRatio(i),this.renderer.setSize(n,r,!1);let a=Math.max(1,Math.floor(n*i)),o=Math.max(1,Math.floor(r*i));this.fboSource.setSize(a,o),this.fboBright.setSize(a,o),this.fboBlurH.setSize(a,o),this.fboBlurV.setSize(a,o),this.sceneMat.uniforms.uResolution.value.set(a,o),this.blurHMat.uniforms.uResolution.value.set(a,o),this.blurVMat.uniforms.uResolution.value.set(a,o)};loop=e=>{if(this.disposed)return;let t=e*.001,n=Math.min(.1,Math.max(0,t-this.lastT||.016));this.lastT=t,this.fpsAccum+=n,this.fpsFrames+=1,this.fpsAccum>=.4&&(this.fps=this.fpsFrames/this.fpsAccum,this.fpsAccum=0,this.fpsFrames=0),this.sceneMat.uniforms.uTime.value=t,this.sceneMat.uniforms.uMotion.value=this.motion,this.sceneMat.uniforms.uDepth.value=this.depth,this.compMat.uniforms.uTime.value=t;let{renderer:r,camera:i,rtScene:a,quad:o}=this;o.material=this.sceneMat,r.setRenderTarget(this.fboSource),r.render(a,i),this.lumMat.uniforms.tSource.value=this.fboSource.texture,o.material=this.lumMat,r.setRenderTarget(this.fboBright),r.render(a,i),this.blurHMat.uniforms.tGlow.value=this.fboBright.texture,o.material=this.blurHMat,r.setRenderTarget(this.fboBlurH),r.render(a,i),this.blurVMat.uniforms.tGlow.value=this.fboBlurH.texture,o.material=this.blurVMat,r.setRenderTarget(this.fboBlurV),r.render(a,i),this.compMat.uniforms.tScene.value=this.fboSource.texture,this.compMat.uniforms.tGlow.value=this.fboBlurV.texture,o.material=this.compMat,r.setRenderTarget(null),r.render(a,i),this.statsClock+=n,this.statsClock>.12&&(this.statsClock=0,this.onStats?.({motion:this.motion,depth:this.depth,fps:this.fps}))}},Vc=class{filteredX=.5;filteredDepth=.52;pointerX=.5;pointerY=.5;hasPointer=!1;cameraOn=!1;video=null;stream=null;camCanvas=null;camCtx=null;listeners=new Set;target=null;disposed=!1;attach(e){this.target=e,e.addEventListener(`pointermove`,this.onPointer),e.addEventListener(`pointerdown`,this.onPointer),e.addEventListener(`pointerleave`,this.onLeave)}onChange(e){return this.listeners.add(e),()=>this.listeners.delete(e)}async enableCamera(){if(this.cameraOn)return!0;if(!navigator.mediaDevices?.getUserMedia)return!1;try{let e=await navigator.mediaDevices.getUserMedia({video:{width:640,height:480,facingMode:`user`},audio:!1}),t=document.createElement(`video`);t.setAttribute(`playsinline`,`true`),t.muted=!0,t.autoplay=!0,t.srcObject=e,await t.play();let n=document.createElement(`canvas`);return n.width=16,n.height=12,this.camCtx=n.getContext(`2d`,{willReadFrequently:!0}),this.camCanvas=n,this.video=t,this.stream=e,this.cameraOn=!0,!0}catch{return this.cameraOn=!1,!1}}disableCamera(){this.stream?.getTracks().forEach(e=>e.stop()),this.stream=null,this.video&&=(this.video.srcObject=null,null),this.camCanvas=null,this.camCtx=null,this.cameraOn=!1}get cameraEnabled(){return this.cameraOn}tick(e){if(this.disposed)return;let t=this.pointerX,n=1-this.pointerY,r=this.hasPointer?`pointer`:`idle`;if(this.cameraOn){let e=this.sampleCamera();e&&(t=e.x,n=e.depth,r=`camera`)}else this.hasPointer||(t=.5+Math.sin(e*.22)*.18,n=.5+Math.sin(e*.14+1.2)*.12);this.filteredX=Fc*t+(1-Fc)*this.filteredX,this.filteredDepth=Fc*n+(1-Fc)*this.filteredDepth;let i={x:this.filteredX,depth:this.filteredDepth,source:r};return this.listeners.forEach(e=>e(i)),i}dispose(){this.disposed=!0,this.disableCamera(),this.target?.removeEventListener(`pointermove`,this.onPointer),this.target?.removeEventListener(`pointerdown`,this.onPointer),this.target?.removeEventListener(`pointerleave`,this.onLeave),this.listeners.clear()}onPointer=e=>{let t=this.target;if(!t)return;let n=t.getBoundingClientRect();n.width<=0||n.height<=0||(this.pointerX=Math.min(1,Math.max(0,(e.clientX-n.left)/n.width)),this.pointerY=Math.min(1,Math.max(0,(e.clientY-n.top)/n.height)),this.hasPointer=!0)};onLeave=()=>{this.hasPointer=!1};sampleCamera(){let e=this.video,t=this.camCtx;if(!e||!t||e.readyState<2)return null;t.drawImage(e,0,0,16,12);let n=t.getImageData(0,0,16,12).data,r=0,i=0,a=0;for(let e=0;e<12;e++)for(let t=0;t<16;t++){let o=(e*16+t)*4,s=(n[o]+n[o+1]+n[o+2])/3;a+=s,s>45&&(r+=t,i++)}return{x:i>0?1-r/i/16:.5,depth:Math.min(1,Math.max(0,a/192/180))}}},X=t();function Hc({scene:e,params:t,cameraLock:n,onStats:r,onCameraStatus:i}){let a=(0,c.useRef)(null),o=(0,c.useRef)(null),s=(0,c.useRef)(null),l=(0,c.useRef)(null),u=(0,c.useRef)(r),d=(0,c.useRef)(i);return u.current=r,d.current=i,(0,c.useEffect)(()=>{let e=o.current,t=a.current;if(!e||!t)return;let n=new Bc({canvas:e,onStats:e=>u.current(e)}),r=new Vc;r.attach(t),s.current=n,l.current=r;let i=0,c=e=>{let t=r.tick(e*.001);t&&n.setMotion(t.x,t.depth),i=requestAnimationFrame(c)};return i=requestAnimationFrame(c),()=>{cancelAnimationFrame(i),r.dispose(),n.dispose(),s.current=null,l.current=null}},[]),(0,c.useEffect)(()=>{s.current?.setScene(e)},[e]),(0,c.useEffect)(()=>{s.current?.setParams(t)},[t]),(0,c.useEffect)(()=>{let e=l.current;if(!e)return;let t=!1;return n?e.enableCamera().then(e=>{t||d.current(e)}):(e.disableCamera(),d.current(!1)),()=>{t=!0}},[n]),(0,X.jsx)(`div`,{ref:a,className:`absolute inset-0 touch-none`,children:(0,X.jsx)(`canvas`,{ref:o,className:`block h-full w-full`})})}function Uc(e){var t,n,r=``;if(typeof e==`string`||typeof e==`number`)r+=e;else if(typeof e==`object`){if(Array.isArray(e)){var i=e.length;for(t=0;t<i;t++)e[t]&&(n=Uc(e[t]))&&(r&&(r+=` `),r+=n)}else for(n in e)e[n]&&(r&&(r+=` `),r+=n)}return r}function Wc(){for(var e,t,n=0,r=``,i=arguments.length;n<i;n++)(e=arguments[n])&&(t=Uc(e))&&(r&&(r+=` `),r+=t);return r}var Gc=(e,t)=>{let n=Array(e.length+t.length);for(let t=0;t<e.length;t++)n[t]=e[t];for(let r=0;r<t.length;r++)n[e.length+r]=t[r];return n},Kc=(e,t)=>({classGroupId:e,validator:t}),qc=(e=new Map,t=null,n)=>({nextPart:e,validators:t,classGroupId:n}),Jc=`-`,Yc=[],Xc=`arbitrary..`,Zc=e=>{let t=el(e),{conflictingClassGroups:n,conflictingClassGroupModifiers:r}=e;return{getClassGroupId:e=>{if(e.startsWith(`[`)&&e.endsWith(`]`))return $c(e);let n=e.split(Jc);return Qc(n,+(n[0]===``&&n.length>1),t)},getConflictingClassGroupIds:(e,t)=>{if(t){let t=r[e],i=n[e];return t?i?Gc(i,t):t:i||Yc}return n[e]||Yc}}},Qc=(e,t,n)=>{if(e.length-t===0)return n.classGroupId;let r=e[t],i=n.nextPart.get(r);if(i){let n=Qc(e,t+1,i);if(n)return n}let a=n.validators;if(a===null)return;let o=t===0?e.join(Jc):e.slice(t).join(Jc),s=a.length;for(let e=0;e<s;e++){let t=a[e];if(t.validator(o))return t.classGroupId}},$c=e=>e.slice(1,-1).indexOf(`:`)===-1?void 0:(()=>{let t=e.slice(1,-1),n=t.indexOf(`:`),r=t.slice(0,n);return r?Xc+r:void 0})(),el=e=>{let{theme:t,classGroups:n}=e;return tl(n,t)},tl=(e,t)=>{let n=qc();for(let r in e){let i=e[r];nl(i,n,r,t)}return n},nl=(e,t,n,r)=>{let i=e.length;for(let a=0;a<i;a++){let i=e[a];rl(i,t,n,r)}},rl=(e,t,n,r)=>{if(typeof e==`string`){il(e,t,n);return}if(typeof e==`function`){al(e,t,n,r);return}ol(e,t,n,r)},il=(e,t,n)=>{let r=e===``?t:sl(t,e);r.classGroupId=n},al=(e,t,n,r)=>{if(cl(e)){nl(e(r),t,n,r);return}t.validators===null&&(t.validators=[]),t.validators.push(Kc(n,e))},ol=(e,t,n,r)=>{let i=Object.entries(e),a=i.length;for(let e=0;e<a;e++){let[a,o]=i[e];nl(o,sl(t,a),n,r)}},sl=(e,t)=>{let n=e,r=t.split(Jc),i=r.length;for(let e=0;e<i;e++){let t=r[e],i=n.nextPart.get(t);i||(i=qc(),n.nextPart.set(t,i)),n=i}return n},cl=e=>`isThemeGetter`in e&&e.isThemeGetter===!0,ll=e=>{if(e<1)return{get:()=>void 0,set:()=>{}};let t=0,n=Object.create(null),r=Object.create(null),i=(i,a)=>{n[i]=a,t++,t>e&&(t=0,r=n,n=Object.create(null))};return{get(e){let t=n[e];if(t!==void 0)return t;if((t=r[e])!==void 0)return i(e,t),t},set(e,t){e in n?n[e]=t:i(e,t)}}},ul=`!`,dl=`:`,fl=[],pl=(e,t,n,r,i)=>({modifiers:e,hasImportantModifier:t,baseClassName:n,maybePostfixModifierPosition:r,isExternal:i}),ml=e=>{let{prefix:t,experimentalParseClassName:n}=e,r=e=>{let t=[],n=0,r=0,i=0,a,o=e.length;for(let s=0;s<o;s++){let o=e[s];if(n===0&&r===0){if(o===dl){t.push(e.slice(i,s)),i=s+1;continue}if(o===`/`){a=s;continue}}o===`[`?n++:o===`]`?n--:o===`(`?r++:o===`)`&&r--}let s=t.length===0?e:e.slice(i),c=s,l=!1;s.endsWith(ul)?(c=s.slice(0,-1),l=!0):s.startsWith(ul)&&(c=s.slice(1),l=!0);let u=a&&a>i?a-i:void 0;return pl(t,l,c,u)};if(t){let e=t+dl,n=r;r=t=>t.startsWith(e)?n(t.slice(e.length)):pl(fl,!1,t,void 0,!0)}if(n){let e=r;r=t=>n({className:t,parseClassName:e})}return r},hl=e=>{let t=new Map;return e.orderSensitiveModifiers.forEach((e,n)=>{t.set(e,1e6+n)}),e=>{let n=[],r=[];for(let i=0;i<e.length;i++){let a=e[i],o=a[0]===`[`,s=t.has(a);o||s?(r.length>0&&(r.sort(),n.push(...r),r=[]),n.push(a)):r.push(a)}return r.length>0&&(r.sort(),n.push(...r)),n}},gl=e=>({cache:ll(e.cacheSize),parseClassName:ml(e),sortModifiers:hl(e),postfixLookupClassGroupIds:_l(e),...Zc(e)}),_l=e=>{let t=Object.create(null),n=e.postfixLookupClassGroups;if(n)for(let e=0;e<n.length;e++)t[n[e]]=!0;return t},vl=/\s+/,yl=(e,t)=>{let{parseClassName:n,getClassGroupId:r,getConflictingClassGroupIds:i,sortModifiers:a,postfixLookupClassGroupIds:o}=t,s=[],c=e.trim().split(vl),l=``;for(let e=c.length-1;e>=0;--e){let t=c[e],{isExternal:u,modifiers:d,hasImportantModifier:f,baseClassName:p,maybePostfixModifierPosition:m}=n(t);if(u){l=t+(l.length>0?` `+l:l);continue}let h=!!m,g;if(h){g=r(p.substring(0,m));let e=g&&o[g]?r(p):void 0;e&&e!==g&&(g=e,h=!1)}else g=r(p);if(!g){if(!h){l=t+(l.length>0?` `+l:l);continue}if(g=r(p),!g){l=t+(l.length>0?` `+l:l);continue}h=!1}let _=d.length===0?``:d.length===1?d[0]:a(d).join(`:`),v=f?_+ul:_,y=v+g;if(s.indexOf(y)>-1)continue;s.push(y);let b=i(g,h);for(let e=0;e<b.length;++e){let t=b[e];s.push(v+t)}l=t+(l.length>0?` `+l:l)}return l},bl=(...e)=>{let t=0,n,r,i=``;for(;t<e.length;)(n=e[t++])&&(r=xl(n))&&(i&&(i+=` `),i+=r);return i},xl=e=>{if(typeof e==`string`)return e;let t,n=``;for(let r=0;r<e.length;r++)e[r]&&(t=xl(e[r]))&&(n&&(n+=` `),n+=t);return n},Sl=(e,...t)=>{let n,r,i,a,o=o=>(n=gl(t.reduce((e,t)=>t(e),e())),r=n.cache.get,i=n.cache.set,a=s,s(o)),s=e=>{let t=r(e);if(t)return t;let a=yl(e,n);return i(e,a),a};return a=o,(...e)=>a(bl(...e))},Cl=[],wl=e=>{let t=t=>t[e]||Cl;return t.isThemeGetter=!0,t},Tl=/^\[(?:(\w[\w-]*):)?(.+)\]$/i,El=/^\((?:(\w[\w-]*):)?(.+)\)$/i,Dl=/^\d+(?:\.\d+)?\/\d+(?:\.\d+)?$/,Ol=/^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/,kl=/\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/,Al=/^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix)\(.+\)$/,jl=/^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/,Ml=/^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/,Nl=e=>Dl.test(e),Z=e=>!!e&&!Number.isNaN(Number(e)),Pl=e=>!!e&&Number.isInteger(Number(e)),Fl=e=>e.endsWith(`%`)&&Z(e.slice(0,-1)),Il=e=>Ol.test(e),Ll=()=>!0,Rl=e=>kl.test(e)&&!Al.test(e),zl=()=>!1,Bl=e=>jl.test(e),Vl=e=>Ml.test(e),Hl=e=>!Q(e)&&!$(e),Ul=e=>e.startsWith(`@container`)&&(e[10]===`/`&&e[11]!==void 0||e[11]===`s`&&e[16]!==void 0&&e.startsWith(`-size/`,10)||e[11]===`n`&&e[18]!==void 0&&e.startsWith(`-normal/`,10)),Wl=e=>au(e,lu,zl),Q=e=>Tl.test(e),Gl=e=>au(e,uu,Rl),Kl=e=>au(e,du,Z),ql=e=>au(e,pu,Ll),Jl=e=>au(e,fu,zl),Yl=e=>au(e,su,zl),Xl=e=>au(e,cu,Vl),Zl=e=>au(e,mu,Bl),$=e=>El.test(e),Ql=e=>ou(e,uu),$l=e=>ou(e,fu),eu=e=>ou(e,su),tu=e=>ou(e,lu),nu=e=>ou(e,cu),ru=e=>ou(e,mu,!0),iu=e=>ou(e,pu,!0),au=(e,t,n)=>{let r=Tl.exec(e);return r?r[1]?t(r[1]):n(r[2]):!1},ou=(e,t,n=!1)=>{let r=El.exec(e);return r?r[1]?t(r[1]):n:!1},su=e=>e===`position`||e===`percentage`,cu=e=>e===`image`||e===`url`,lu=e=>e===`length`||e===`size`||e===`bg-size`,uu=e=>e===`length`,du=e=>e===`number`,fu=e=>e===`family-name`,pu=e=>e===`number`||e===`weight`,mu=e=>e===`shadow`,hu=Sl(()=>{let e=wl(`color`),t=wl(`font`),n=wl(`text`),r=wl(`font-weight`),i=wl(`tracking`),a=wl(`leading`),o=wl(`breakpoint`),s=wl(`container`),c=wl(`spacing`),l=wl(`radius`),u=wl(`shadow`),d=wl(`inset-shadow`),f=wl(`text-shadow`),p=wl(`drop-shadow`),m=wl(`blur`),h=wl(`perspective`),g=wl(`aspect`),_=wl(`ease`),v=wl(`animate`),y=()=>[`auto`,`avoid`,`all`,`avoid-page`,`page`,`left`,`right`,`column`],b=()=>[`center`,`top`,`bottom`,`left`,`right`,`top-left`,`left-top`,`top-right`,`right-top`,`bottom-right`,`right-bottom`,`bottom-left`,`left-bottom`],x=()=>[...b(),$,Q],S=()=>[`auto`,`hidden`,`clip`,`visible`,`scroll`],C=()=>[`auto`,`contain`,`none`],w=()=>[$,Q,c],T=()=>[Nl,`full`,`auto`,...w()],E=()=>[Pl,`none`,`subgrid`,$,Q],D=()=>[`auto`,{span:[`full`,Pl,$,Q]},Pl,$,Q],ee=()=>[Pl,`auto`,$,Q],O=()=>[`auto`,`min`,`max`,`fr`,$,Q],k=()=>[`start`,`end`,`center`,`between`,`around`,`evenly`,`stretch`,`baseline`,`center-safe`,`end-safe`],A=()=>[`start`,`end`,`center`,`stretch`,`center-safe`,`end-safe`],j=()=>[`auto`,...w()],M=()=>[Nl,`auto`,`full`,`dvw`,`dvh`,`lvw`,`lvh`,`svw`,`svh`,`min`,`max`,`fit`,...w()],te=()=>[Nl,`screen`,`full`,`dvw`,`lvw`,`svw`,`min`,`max`,`fit`,...w()],N=()=>[Nl,`screen`,`full`,`lh`,`dvh`,`lvh`,`svh`,`min`,`max`,`fit`,...w()],P=()=>[e,$,Q],ne=()=>[...b(),eu,Yl,{position:[$,Q]}],re=()=>[`no-repeat`,{repeat:[``,`x`,`y`,`space`,`round`]}],ie=()=>[`auto`,`cover`,`contain`,tu,Wl,{size:[$,Q]}],ae=()=>[Fl,Ql,Gl],oe=()=>[``,`none`,`full`,l,$,Q],se=()=>[``,Z,Ql,Gl],ce=()=>[`solid`,`dashed`,`dotted`,`double`],F=()=>[`normal`,`multiply`,`screen`,`overlay`,`darken`,`lighten`,`color-dodge`,`color-burn`,`hard-light`,`soft-light`,`difference`,`exclusion`,`hue`,`saturation`,`color`,`luminosity`],I=()=>[Z,Fl,eu,Yl],le=()=>[``,`none`,m,$,Q],ue=()=>[`none`,Z,$,Q],de=()=>[`none`,Z,$,Q],fe=()=>[Z,$,Q],pe=()=>[Nl,`full`,...w()];return{cacheSize:500,theme:{animate:[`spin`,`ping`,`pulse`,`bounce`],aspect:[`video`],blur:[Il],breakpoint:[Il],color:[Ll],container:[Il],"drop-shadow":[Il],ease:[`in`,`out`,`in-out`],font:[Hl],"font-weight":[`thin`,`extralight`,`light`,`normal`,`medium`,`semibold`,`bold`,`extrabold`,`black`],"inset-shadow":[Il],leading:[`none`,`tight`,`snug`,`normal`,`relaxed`,`loose`],perspective:[`dramatic`,`near`,`normal`,`midrange`,`distant`,`none`],radius:[Il],shadow:[Il],spacing:[`px`,Z],text:[Il],"text-shadow":[Il],tracking:[`tighter`,`tight`,`normal`,`wide`,`wider`,`widest`]},classGroups:{aspect:[{aspect:[`auto`,`square`,Nl,Q,$,g]}],container:[`container`],"container-type":[{"@container":[``,`normal`,`size`,$,Q]}],"container-named":[Ul],columns:[{columns:[Z,Q,$,s]}],"break-after":[{"break-after":y()}],"break-before":[{"break-before":y()}],"break-inside":[{"break-inside":[`auto`,`avoid`,`avoid-page`,`avoid-column`]}],"box-decoration":[{"box-decoration":[`slice`,`clone`]}],box:[{box:[`border`,`content`]}],display:[`block`,`inline-block`,`inline`,`flex`,`inline-flex`,`table`,`inline-table`,`table-caption`,`table-cell`,`table-column`,`table-column-group`,`table-footer-group`,`table-header-group`,`table-row-group`,`table-row`,`flow-root`,`grid`,`inline-grid`,`contents`,`list-item`,`hidden`],sr:[`sr-only`,`not-sr-only`],float:[{float:[`right`,`left`,`none`,`start`,`end`]}],clear:[{clear:[`left`,`right`,`both`,`none`,`start`,`end`]}],isolation:[`isolate`,`isolation-auto`],"object-fit":[{object:[`contain`,`cover`,`fill`,`none`,`scale-down`]}],"object-position":[{object:x()}],overflow:[{overflow:S()}],"overflow-x":[{"overflow-x":S()}],"overflow-y":[{"overflow-y":S()}],overscroll:[{overscroll:C()}],"overscroll-x":[{"overscroll-x":C()}],"overscroll-y":[{"overscroll-y":C()}],position:[`static`,`fixed`,`absolute`,`relative`,`sticky`],inset:[{inset:T()}],"inset-x":[{"inset-x":T()}],"inset-y":[{"inset-y":T()}],start:[{"inset-s":T(),start:T()}],end:[{"inset-e":T(),end:T()}],"inset-bs":[{"inset-bs":T()}],"inset-be":[{"inset-be":T()}],top:[{top:T()}],right:[{right:T()}],bottom:[{bottom:T()}],left:[{left:T()}],visibility:[`visible`,`invisible`,`collapse`],z:[{z:[Pl,`auto`,$,Q]}],basis:[{basis:[Nl,`full`,`auto`,s,...w()]}],"flex-direction":[{flex:[`row`,`row-reverse`,`col`,`col-reverse`]}],"flex-wrap":[{flex:[`nowrap`,`wrap`,`wrap-reverse`]}],flex:[{flex:[Z,Nl,`auto`,`initial`,`none`,Q]}],grow:[{grow:[``,Z,$,Q]}],shrink:[{shrink:[``,Z,$,Q]}],order:[{order:[Pl,`first`,`last`,`none`,$,Q]}],"grid-cols":[{"grid-cols":E()}],"col-start-end":[{col:D()}],"col-start":[{"col-start":ee()}],"col-end":[{"col-end":ee()}],"grid-rows":[{"grid-rows":E()}],"row-start-end":[{row:D()}],"row-start":[{"row-start":ee()}],"row-end":[{"row-end":ee()}],"grid-flow":[{"grid-flow":[`row`,`col`,`dense`,`row-dense`,`col-dense`]}],"auto-cols":[{"auto-cols":O()}],"auto-rows":[{"auto-rows":O()}],gap:[{gap:w()}],"gap-x":[{"gap-x":w()}],"gap-y":[{"gap-y":w()}],"justify-content":[{justify:[...k(),`normal`]}],"justify-items":[{"justify-items":[...A(),`normal`]}],"justify-self":[{"justify-self":[`auto`,...A()]}],"align-content":[{content:[`normal`,...k()]}],"align-items":[{items:[...A(),{baseline:[``,`last`]}]}],"align-self":[{self:[`auto`,...A(),{baseline:[``,`last`]}]}],"place-content":[{"place-content":k()}],"place-items":[{"place-items":[...A(),`baseline`]}],"place-self":[{"place-self":[`auto`,...A()]}],p:[{p:w()}],px:[{px:w()}],py:[{py:w()}],ps:[{ps:w()}],pe:[{pe:w()}],pbs:[{pbs:w()}],pbe:[{pbe:w()}],pt:[{pt:w()}],pr:[{pr:w()}],pb:[{pb:w()}],pl:[{pl:w()}],m:[{m:j()}],mx:[{mx:j()}],my:[{my:j()}],ms:[{ms:j()}],me:[{me:j()}],mbs:[{mbs:j()}],mbe:[{mbe:j()}],mt:[{mt:j()}],mr:[{mr:j()}],mb:[{mb:j()}],ml:[{ml:j()}],"space-x":[{"space-x":w()}],"space-x-reverse":[`space-x-reverse`],"space-y":[{"space-y":w()}],"space-y-reverse":[`space-y-reverse`],size:[{size:M()}],"inline-size":[{inline:[`auto`,...te()]}],"min-inline-size":[{"min-inline":[`auto`,...te()]}],"max-inline-size":[{"max-inline":[`none`,...te()]}],"block-size":[{block:[`auto`,...N()]}],"min-block-size":[{"min-block":[`auto`,...N()]}],"max-block-size":[{"max-block":[`none`,...N()]}],w:[{w:[s,`screen`,...M()]}],"min-w":[{"min-w":[s,`screen`,`none`,...M()]}],"max-w":[{"max-w":[s,`screen`,`none`,`prose`,{screen:[o]},...M()]}],h:[{h:[`screen`,`lh`,...M()]}],"min-h":[{"min-h":[`screen`,`lh`,`none`,...M()]}],"max-h":[{"max-h":[`screen`,`lh`,...M()]}],"font-size":[{text:[`base`,n,Ql,Gl]}],"font-smoothing":[`antialiased`,`subpixel-antialiased`],"font-style":[`italic`,`not-italic`],"font-weight":[{font:[r,iu,ql]}],"font-stretch":[{"font-stretch":[`ultra-condensed`,`extra-condensed`,`condensed`,`semi-condensed`,`normal`,`semi-expanded`,`expanded`,`extra-expanded`,`ultra-expanded`,Fl,Q]}],"font-family":[{font:[$l,Jl,t]}],"font-features":[{"font-features":[Q]}],"fvn-normal":[`normal-nums`],"fvn-ordinal":[`ordinal`],"fvn-slashed-zero":[`slashed-zero`],"fvn-figure":[`lining-nums`,`oldstyle-nums`],"fvn-spacing":[`proportional-nums`,`tabular-nums`],"fvn-fraction":[`diagonal-fractions`,`stacked-fractions`],tracking:[{tracking:[i,$,Q]}],"line-clamp":[{"line-clamp":[Z,`none`,$,Kl]}],leading:[{leading:[a,...w()]}],"list-image":[{"list-image":[`none`,$,Q]}],"list-style-position":[{list:[`inside`,`outside`]}],"list-style-type":[{list:[`disc`,`decimal`,`none`,$,Q]}],"text-alignment":[{text:[`left`,`center`,`right`,`justify`,`start`,`end`]}],"placeholder-color":[{placeholder:P()}],"text-color":[{text:P()}],"text-decoration":[`underline`,`overline`,`line-through`,`no-underline`],"text-decoration-style":[{decoration:[...ce(),`wavy`]}],"text-decoration-thickness":[{decoration:[Z,`from-font`,`auto`,$,Gl]}],"text-decoration-color":[{decoration:P()}],"underline-offset":[{"underline-offset":[Z,`auto`,$,Q]}],"text-transform":[`uppercase`,`lowercase`,`capitalize`,`normal-case`],"text-overflow":[`truncate`,`text-ellipsis`,`text-clip`],"text-wrap":[{text:[`wrap`,`nowrap`,`balance`,`pretty`]}],indent:[{indent:w()}],"tab-size":[{tab:[Pl,$,Q]}],"vertical-align":[{align:[`baseline`,`top`,`middle`,`bottom`,`text-top`,`text-bottom`,`sub`,`super`,$,Q]}],whitespace:[{whitespace:[`normal`,`nowrap`,`pre`,`pre-line`,`pre-wrap`,`break-spaces`]}],break:[{break:[`normal`,`words`,`all`,`keep`]}],wrap:[{wrap:[`break-word`,`anywhere`,`normal`]}],hyphens:[{hyphens:[`none`,`manual`,`auto`]}],content:[{content:[`none`,$,Q]}],"bg-attachment":[{bg:[`fixed`,`local`,`scroll`]}],"bg-clip":[{"bg-clip":[`border`,`padding`,`content`,`text`]}],"bg-origin":[{"bg-origin":[`border`,`padding`,`content`]}],"bg-position":[{bg:ne()}],"bg-repeat":[{bg:re()}],"bg-size":[{bg:ie()}],"bg-image":[{bg:[`none`,{linear:[{to:[`t`,`tr`,`r`,`br`,`b`,`bl`,`l`,`tl`]},Pl,$,Q],radial:[``,$,Q],conic:[Pl,$,Q]},nu,Xl]}],"bg-color":[{bg:P()}],"gradient-from-pos":[{from:ae()}],"gradient-via-pos":[{via:ae()}],"gradient-to-pos":[{to:ae()}],"gradient-from":[{from:P()}],"gradient-via":[{via:P()}],"gradient-to":[{to:P()}],rounded:[{rounded:oe()}],"rounded-s":[{"rounded-s":oe()}],"rounded-e":[{"rounded-e":oe()}],"rounded-t":[{"rounded-t":oe()}],"rounded-r":[{"rounded-r":oe()}],"rounded-b":[{"rounded-b":oe()}],"rounded-l":[{"rounded-l":oe()}],"rounded-ss":[{"rounded-ss":oe()}],"rounded-se":[{"rounded-se":oe()}],"rounded-ee":[{"rounded-ee":oe()}],"rounded-es":[{"rounded-es":oe()}],"rounded-tl":[{"rounded-tl":oe()}],"rounded-tr":[{"rounded-tr":oe()}],"rounded-br":[{"rounded-br":oe()}],"rounded-bl":[{"rounded-bl":oe()}],"border-w":[{border:se()}],"border-w-x":[{"border-x":se()}],"border-w-y":[{"border-y":se()}],"border-w-s":[{"border-s":se()}],"border-w-e":[{"border-e":se()}],"border-w-bs":[{"border-bs":se()}],"border-w-be":[{"border-be":se()}],"border-w-t":[{"border-t":se()}],"border-w-r":[{"border-r":se()}],"border-w-b":[{"border-b":se()}],"border-w-l":[{"border-l":se()}],"divide-x":[{"divide-x":se()}],"divide-x-reverse":[`divide-x-reverse`],"divide-y":[{"divide-y":se()}],"divide-y-reverse":[`divide-y-reverse`],"border-style":[{border:[...ce(),`hidden`,`none`]}],"divide-style":[{divide:[...ce(),`hidden`,`none`]}],"border-color":[{border:P()}],"border-color-x":[{"border-x":P()}],"border-color-y":[{"border-y":P()}],"border-color-s":[{"border-s":P()}],"border-color-e":[{"border-e":P()}],"border-color-bs":[{"border-bs":P()}],"border-color-be":[{"border-be":P()}],"border-color-t":[{"border-t":P()}],"border-color-r":[{"border-r":P()}],"border-color-b":[{"border-b":P()}],"border-color-l":[{"border-l":P()}],"divide-color":[{divide:P()}],"outline-style":[{outline:[...ce(),`none`,`hidden`]}],"outline-offset":[{"outline-offset":[Z,$,Q]}],"outline-w":[{outline:[``,Z,Ql,Gl]}],"outline-color":[{outline:P()}],shadow:[{shadow:[``,`none`,u,ru,Zl]}],"shadow-color":[{shadow:P()}],"inset-shadow":[{"inset-shadow":[`none`,d,ru,Zl]}],"inset-shadow-color":[{"inset-shadow":P()}],"ring-w":[{ring:se()}],"ring-w-inset":[`ring-inset`],"ring-color":[{ring:P()}],"ring-offset-w":[{"ring-offset":[Z,Gl]}],"ring-offset-color":[{"ring-offset":P()}],"inset-ring-w":[{"inset-ring":se()}],"inset-ring-color":[{"inset-ring":P()}],"text-shadow":[{"text-shadow":[`none`,f,ru,Zl]}],"text-shadow-color":[{"text-shadow":P()}],opacity:[{opacity:[Z,$,Q]}],"mix-blend":[{"mix-blend":[...F(),`plus-darker`,`plus-lighter`]}],"bg-blend":[{"bg-blend":F()}],"mask-clip":[{"mask-clip":[`border`,`padding`,`content`,`fill`,`stroke`,`view`]},`mask-no-clip`],"mask-composite":[{mask:[`add`,`subtract`,`intersect`,`exclude`]}],"mask-image-linear-pos":[{"mask-linear":[Z]}],"mask-image-linear-from-pos":[{"mask-linear-from":I()}],"mask-image-linear-to-pos":[{"mask-linear-to":I()}],"mask-image-linear-from-color":[{"mask-linear-from":P()}],"mask-image-linear-to-color":[{"mask-linear-to":P()}],"mask-image-t-from-pos":[{"mask-t-from":I()}],"mask-image-t-to-pos":[{"mask-t-to":I()}],"mask-image-t-from-color":[{"mask-t-from":P()}],"mask-image-t-to-color":[{"mask-t-to":P()}],"mask-image-r-from-pos":[{"mask-r-from":I()}],"mask-image-r-to-pos":[{"mask-r-to":I()}],"mask-image-r-from-color":[{"mask-r-from":P()}],"mask-image-r-to-color":[{"mask-r-to":P()}],"mask-image-b-from-pos":[{"mask-b-from":I()}],"mask-image-b-to-pos":[{"mask-b-to":I()}],"mask-image-b-from-color":[{"mask-b-from":P()}],"mask-image-b-to-color":[{"mask-b-to":P()}],"mask-image-l-from-pos":[{"mask-l-from":I()}],"mask-image-l-to-pos":[{"mask-l-to":I()}],"mask-image-l-from-color":[{"mask-l-from":P()}],"mask-image-l-to-color":[{"mask-l-to":P()}],"mask-image-x-from-pos":[{"mask-x-from":I()}],"mask-image-x-to-pos":[{"mask-x-to":I()}],"mask-image-x-from-color":[{"mask-x-from":P()}],"mask-image-x-to-color":[{"mask-x-to":P()}],"mask-image-y-from-pos":[{"mask-y-from":I()}],"mask-image-y-to-pos":[{"mask-y-to":I()}],"mask-image-y-from-color":[{"mask-y-from":P()}],"mask-image-y-to-color":[{"mask-y-to":P()}],"mask-image-radial":[{"mask-radial":[$,Q]}],"mask-image-radial-from-pos":[{"mask-radial-from":I()}],"mask-image-radial-to-pos":[{"mask-radial-to":I()}],"mask-image-radial-from-color":[{"mask-radial-from":P()}],"mask-image-radial-to-color":[{"mask-radial-to":P()}],"mask-image-radial-shape":[{"mask-radial":[`circle`,`ellipse`]}],"mask-image-radial-size":[{"mask-radial":[{closest:[`side`,`corner`],farthest:[`side`,`corner`]}]}],"mask-image-radial-pos":[{"mask-radial-at":b()}],"mask-image-conic-pos":[{"mask-conic":[Z]}],"mask-image-conic-from-pos":[{"mask-conic-from":I()}],"mask-image-conic-to-pos":[{"mask-conic-to":I()}],"mask-image-conic-from-color":[{"mask-conic-from":P()}],"mask-image-conic-to-color":[{"mask-conic-to":P()}],"mask-mode":[{mask:[`alpha`,`luminance`,`match`]}],"mask-origin":[{"mask-origin":[`border`,`padding`,`content`,`fill`,`stroke`,`view`]}],"mask-position":[{mask:ne()}],"mask-repeat":[{mask:re()}],"mask-size":[{mask:ie()}],"mask-type":[{"mask-type":[`alpha`,`luminance`]}],"mask-image":[{mask:[`none`,$,Q]}],filter:[{filter:[``,`none`,$,Q]}],blur:[{blur:le()}],brightness:[{brightness:[Z,$,Q]}],contrast:[{contrast:[Z,$,Q]}],"drop-shadow":[{"drop-shadow":[``,`none`,p,ru,Zl]}],"drop-shadow-color":[{"drop-shadow":P()}],grayscale:[{grayscale:[``,Z,$,Q]}],"hue-rotate":[{"hue-rotate":[Z,$,Q]}],invert:[{invert:[``,Z,$,Q]}],saturate:[{saturate:[Z,$,Q]}],sepia:[{sepia:[``,Z,$,Q]}],"backdrop-filter":[{"backdrop-filter":[``,`none`,$,Q]}],"backdrop-blur":[{"backdrop-blur":le()}],"backdrop-brightness":[{"backdrop-brightness":[Z,$,Q]}],"backdrop-contrast":[{"backdrop-contrast":[Z,$,Q]}],"backdrop-grayscale":[{"backdrop-grayscale":[``,Z,$,Q]}],"backdrop-hue-rotate":[{"backdrop-hue-rotate":[Z,$,Q]}],"backdrop-invert":[{"backdrop-invert":[``,Z,$,Q]}],"backdrop-opacity":[{"backdrop-opacity":[Z,$,Q]}],"backdrop-saturate":[{"backdrop-saturate":[Z,$,Q]}],"backdrop-sepia":[{"backdrop-sepia":[``,Z,$,Q]}],"border-collapse":[{border:[`collapse`,`separate`]}],"border-spacing":[{"border-spacing":w()}],"border-spacing-x":[{"border-spacing-x":w()}],"border-spacing-y":[{"border-spacing-y":w()}],"table-layout":[{table:[`auto`,`fixed`]}],caption:[{caption:[`top`,`bottom`]}],transition:[{transition:[``,`all`,`colors`,`opacity`,`shadow`,`transform`,`none`,$,Q]}],"transition-behavior":[{transition:[`normal`,`discrete`]}],duration:[{duration:[Z,`initial`,$,Q]}],ease:[{ease:[`linear`,`initial`,_,$,Q]}],delay:[{delay:[Z,$,Q]}],animate:[{animate:[`none`,v,$,Q]}],backface:[{backface:[`hidden`,`visible`]}],perspective:[{perspective:[h,$,Q]}],"perspective-origin":[{"perspective-origin":x()}],rotate:[{rotate:ue()}],"rotate-x":[{"rotate-x":ue()}],"rotate-y":[{"rotate-y":ue()}],"rotate-z":[{"rotate-z":ue()}],scale:[{scale:de()}],"scale-x":[{"scale-x":de()}],"scale-y":[{"scale-y":de()}],"scale-z":[{"scale-z":de()}],"scale-3d":[`scale-3d`],skew:[{skew:fe()}],"skew-x":[{"skew-x":fe()}],"skew-y":[{"skew-y":fe()}],transform:[{transform:[$,Q,``,`none`,`gpu`,`cpu`]}],"transform-origin":[{origin:x()}],"transform-style":[{transform:[`3d`,`flat`]}],translate:[{translate:pe()}],"translate-x":[{"translate-x":pe()}],"translate-y":[{"translate-y":pe()}],"translate-z":[{"translate-z":pe()}],"translate-none":[`translate-none`],zoom:[{zoom:[Pl,$,Q]}],accent:[{accent:P()}],appearance:[{appearance:[`none`,`auto`]}],"caret-color":[{caret:P()}],"color-scheme":[{scheme:[`normal`,`dark`,`light`,`light-dark`,`only-dark`,`only-light`]}],cursor:[{cursor:[`auto`,`default`,`pointer`,`wait`,`text`,`move`,`help`,`not-allowed`,`none`,`context-menu`,`progress`,`cell`,`crosshair`,`vertical-text`,`alias`,`copy`,`no-drop`,`grab`,`grabbing`,`all-scroll`,`col-resize`,`row-resize`,`n-resize`,`e-resize`,`s-resize`,`w-resize`,`ne-resize`,`nw-resize`,`se-resize`,`sw-resize`,`ew-resize`,`ns-resize`,`nesw-resize`,`nwse-resize`,`zoom-in`,`zoom-out`,$,Q]}],"field-sizing":[{"field-sizing":[`fixed`,`content`]}],"pointer-events":[{"pointer-events":[`auto`,`none`]}],resize:[{resize:[`none`,``,`y`,`x`]}],"scroll-behavior":[{scroll:[`auto`,`smooth`]}],"scrollbar-thumb-color":[{"scrollbar-thumb":P()}],"scrollbar-track-color":[{"scrollbar-track":P()}],"scrollbar-gutter":[{"scrollbar-gutter":[`auto`,`stable`,`both`]}],"scrollbar-w":[{scrollbar:[`auto`,`thin`,`none`]}],"scroll-m":[{"scroll-m":w()}],"scroll-mx":[{"scroll-mx":w()}],"scroll-my":[{"scroll-my":w()}],"scroll-ms":[{"scroll-ms":w()}],"scroll-me":[{"scroll-me":w()}],"scroll-mbs":[{"scroll-mbs":w()}],"scroll-mbe":[{"scroll-mbe":w()}],"scroll-mt":[{"scroll-mt":w()}],"scroll-mr":[{"scroll-mr":w()}],"scroll-mb":[{"scroll-mb":w()}],"scroll-ml":[{"scroll-ml":w()}],"scroll-p":[{"scroll-p":w()}],"scroll-px":[{"scroll-px":w()}],"scroll-py":[{"scroll-py":w()}],"scroll-ps":[{"scroll-ps":w()}],"scroll-pe":[{"scroll-pe":w()}],"scroll-pbs":[{"scroll-pbs":w()}],"scroll-pbe":[{"scroll-pbe":w()}],"scroll-pt":[{"scroll-pt":w()}],"scroll-pr":[{"scroll-pr":w()}],"scroll-pb":[{"scroll-pb":w()}],"scroll-pl":[{"scroll-pl":w()}],"snap-align":[{snap:[`start`,`end`,`center`,`align-none`]}],"snap-stop":[{snap:[`normal`,`always`]}],"snap-type":[{snap:[`none`,`x`,`y`,`both`]}],"snap-strictness":[{snap:[`mandatory`,`proximity`]}],touch:[{touch:[`auto`,`none`,`manipulation`]}],"touch-x":[{"touch-pan":[`x`,`left`,`right`]}],"touch-y":[{"touch-pan":[`y`,`up`,`down`]}],"touch-pz":[`touch-pinch-zoom`],select:[{select:[`none`,`text`,`all`,`auto`]}],"will-change":[{"will-change":[`auto`,`scroll`,`contents`,`transform`,$,Q]}],fill:[{fill:[`none`,...P()]}],"stroke-w":[{stroke:[Z,Ql,Gl,Kl]}],stroke:[{stroke:[`none`,...P()]}],"forced-color-adjust":[{"forced-color-adjust":[`auto`,`none`]}]},conflictingClassGroups:{"container-named":[`container-type`],overflow:[`overflow-x`,`overflow-y`],overscroll:[`overscroll-x`,`overscroll-y`],inset:[`inset-x`,`inset-y`,`inset-bs`,`inset-be`,`start`,`end`,`top`,`right`,`bottom`,`left`],"inset-x":[`right`,`left`],"inset-y":[`top`,`bottom`],flex:[`basis`,`grow`,`shrink`],gap:[`gap-x`,`gap-y`],p:[`px`,`py`,`ps`,`pe`,`pbs`,`pbe`,`pt`,`pr`,`pb`,`pl`],px:[`pr`,`pl`],py:[`pt`,`pb`],m:[`mx`,`my`,`ms`,`me`,`mbs`,`mbe`,`mt`,`mr`,`mb`,`ml`],mx:[`mr`,`ml`],my:[`mt`,`mb`],size:[`w`,`h`],"font-size":[`leading`],"fvn-normal":[`fvn-ordinal`,`fvn-slashed-zero`,`fvn-figure`,`fvn-spacing`,`fvn-fraction`],"fvn-ordinal":[`fvn-normal`],"fvn-slashed-zero":[`fvn-normal`],"fvn-figure":[`fvn-normal`],"fvn-spacing":[`fvn-normal`],"fvn-fraction":[`fvn-normal`],"line-clamp":[`display`,`overflow`],rounded:[`rounded-s`,`rounded-e`,`rounded-t`,`rounded-r`,`rounded-b`,`rounded-l`,`rounded-ss`,`rounded-se`,`rounded-ee`,`rounded-es`,`rounded-tl`,`rounded-tr`,`rounded-br`,`rounded-bl`],"rounded-s":[`rounded-ss`,`rounded-es`],"rounded-e":[`rounded-se`,`rounded-ee`],"rounded-t":[`rounded-tl`,`rounded-tr`],"rounded-r":[`rounded-tr`,`rounded-br`],"rounded-b":[`rounded-br`,`rounded-bl`],"rounded-l":[`rounded-tl`,`rounded-bl`],"border-spacing":[`border-spacing-x`,`border-spacing-y`],"border-w":[`border-w-x`,`border-w-y`,`border-w-s`,`border-w-e`,`border-w-bs`,`border-w-be`,`border-w-t`,`border-w-r`,`border-w-b`,`border-w-l`],"border-w-x":[`border-w-r`,`border-w-l`],"border-w-y":[`border-w-t`,`border-w-b`],"border-color":[`border-color-x`,`border-color-y`,`border-color-s`,`border-color-e`,`border-color-bs`,`border-color-be`,`border-color-t`,`border-color-r`,`border-color-b`,`border-color-l`],"border-color-x":[`border-color-r`,`border-color-l`],"border-color-y":[`border-color-t`,`border-color-b`],translate:[`translate-x`,`translate-y`,`translate-none`],"translate-none":[`translate`,`translate-x`,`translate-y`,`translate-z`],"scroll-m":[`scroll-mx`,`scroll-my`,`scroll-ms`,`scroll-me`,`scroll-mbs`,`scroll-mbe`,`scroll-mt`,`scroll-mr`,`scroll-mb`,`scroll-ml`],"scroll-mx":[`scroll-mr`,`scroll-ml`],"scroll-my":[`scroll-mt`,`scroll-mb`],"scroll-p":[`scroll-px`,`scroll-py`,`scroll-ps`,`scroll-pe`,`scroll-pbs`,`scroll-pbe`,`scroll-pt`,`scroll-pr`,`scroll-pb`,`scroll-pl`],"scroll-px":[`scroll-pr`,`scroll-pl`],"scroll-py":[`scroll-pt`,`scroll-pb`],touch:[`touch-x`,`touch-y`,`touch-pz`],"touch-x":[`touch`],"touch-y":[`touch`],"touch-pz":[`touch`]},conflictingClassGroupModifiers:{"font-size":[`leading`]},postfixLookupClassGroups:[`container-type`],orderSensitiveModifiers:[`*`,`**`,`after`,`backdrop`,`before`,`details-content`,`file`,`first-letter`,`first-line`,`marker`,`placeholder`,`selection`]}});function gu(...e){return hu(Wc(e))}function _u({entered:e,scene:t,params:n,cameraLock:r,cameraReady:c,settingsOpen:l,stats:u,onEnter:d,onScene:f,onParams:p,onCameraLock:m,onSettings:h}){let g=1-u.motion;return(0,X.jsxs)(X.Fragment,{children:[!e&&(0,X.jsx)(`div`,{className:`absolute inset-0 z-20 flex items-end justify-start bg-gradient-to-t from-bg via-bg/55 to-transparent p-6 sm:p-10`,children:(0,X.jsxs)(`div`,{className:`max-w-xl pb-[env(safe-area-inset-bottom)]`,children:[(0,X.jsx)(`p`,{className:`mb-3 font-mono text-xs tracking-[0.28em] text-fg-muted uppercase`,children:`Five-channel dual-pass field`}),(0,X.jsx)(`h1`,{className:`font-display text-5xl leading-none tracking-tight text-fg sm:text-7xl`,children:`Photonic-Ω`}),(0,X.jsx)(`p`,{className:`mt-5 max-w-md text-sm leading-relaxed text-fg-muted sm:text-base`,children:`Per-pixel luminance gate, 5D photonic bloom, inverse motion lock. Move left and the field slides right. Lean in and the mandala expands.`}),(0,X.jsx)(`button`,{type:`button`,onClick:d,className:`mt-8 min-h-11 rounded-sm bg-accent px-6 py-3 text-sm font-medium text-accent-fg transition-transform duration-[var(--motion-quick)] ease-[var(--ease-out)] hover:opacity-90 active:scale-[0.98]`,children:`Enter the field`})]})}),e&&(0,X.jsxs)(X.Fragment,{children:[(0,X.jsxs)(`header`,{className:`pointer-events-none absolute top-0 left-0 z-10 flex w-full items-start justify-between gap-3 p-4 sm:p-6`,children:[(0,X.jsxs)(`div`,{className:`pointer-events-auto rounded-lg border border-border bg-bg-elevated/80 px-4 py-3 backdrop-blur-sm`,children:[(0,X.jsx)(`p`,{className:`font-display text-lg leading-none text-fg`,children:`Photonic-Ω`}),(0,X.jsx)(`p`,{className:`mt-1 font-mono text-[0.68rem] tracking-wide text-fg-muted uppercase`,children:`Dual-pass FBO · luminance gate`})]}),(0,X.jsxs)(`div`,{className:`pointer-events-auto flex flex-wrap items-center justify-end gap-2`,children:[Rc.map(e=>(0,X.jsx)(`button`,{type:`button`,onClick:()=>f(e.id),className:gu(`min-h-11 rounded-md border px-3 font-mono text-xs tracking-wide uppercase sm:px-4`,t===e.id?`border-border-strong bg-fg text-bg`:`border-border bg-bg-elevated/80 text-fg-muted hover:text-fg`),children:e.label},e.id)),(0,X.jsx)(`button`,{type:`button`,"aria-label":r?`Release camera`:`Lock camera`,"aria-pressed":r,onClick:()=>m(!r),className:`inline-flex min-h-11 min-w-11 items-center justify-center rounded-md border border-border bg-bg-elevated/80 text-fg backdrop-blur-sm hover:opacity-90`,title:r?`Release camera`:`Lock camera`,children:r&&c?(0,X.jsx)(o,{className:`size-4`,strokeWidth:1.75}):(0,X.jsx)(a,{className:`size-4`,strokeWidth:1.75})}),(0,X.jsx)(`button`,{type:`button`,"aria-label":`Tune pipeline`,"aria-pressed":l,onClick:()=>h(!l),className:`inline-flex min-h-11 min-w-11 items-center justify-center rounded-md border border-border bg-bg-elevated/80 text-fg backdrop-blur-sm hover:opacity-90`,title:`Tune pipeline`,children:(0,X.jsx)(s,{className:`size-4`,strokeWidth:1.75})})]})]}),(0,X.jsxs)(`div`,{className:`pointer-events-none absolute bottom-0 left-0 z-10 flex w-full items-end justify-between gap-3 p-4 sm:p-6`,children:[(0,X.jsx)(`div`,{className:`pointer-events-auto rounded-lg border border-border bg-bg-elevated/80 px-3 py-2.5 backdrop-blur-sm`,children:(0,X.jsx)(`ul`,{className:`flex flex-wrap gap-x-4 gap-y-2`,children:Ic.map((e,t)=>{let n=.35+.65*yu(u.motion,t);return(0,X.jsxs)(`li`,{className:`flex items-center gap-2`,children:[(0,X.jsx)(`span`,{className:`size-1.5 shrink-0 rounded-full`,style:{background:e.color,opacity:.5+n*.5}}),(0,X.jsx)(`span`,{className:`font-mono text-[0.65rem] tracking-wide text-fg uppercase`,children:e.label})]},e.id)})})}),(0,X.jsxs)(`aside`,{className:`rounded-md border border-border bg-bg-elevated/75 px-3 py-2 font-mono text-[0.65rem] text-fg-muted backdrop-blur-sm`,children:[(0,X.jsxs)(`p`,{children:[`offset `,(0,X.jsx)(`span`,{className:`tabular-nums text-fg`,children:u.motion.toFixed(2)}),(0,X.jsx)(`span`,{className:`mx-2 text-fg-subtle`,children:`·`}),`depth `,(0,X.jsx)(`span`,{className:`tabular-nums text-fg`,children:u.depth.toFixed(2)})]}),(0,X.jsxs)(`p`,{className:`text-fg-subtle`,children:[`shift `,g.toFixed(2),` · `,Math.round(u.fps),` fps ·`,` `,r&&c?`camera`:`pointer`]})]})]})]}),e&&l&&(0,X.jsxs)(`div`,{className:`absolute top-24 right-4 z-20 w-[min(18rem,calc(100vw-2rem))] rounded-xl border border-border bg-bg-elevated p-4 shadow-lg sm:right-6`,children:[(0,X.jsxs)(`div`,{className:`mb-3 flex items-center gap-2 text-fg`,children:[(0,X.jsx)(i,{className:`size-4`,strokeWidth:1.75}),(0,X.jsx)(`p`,{className:`font-display text-sm`,children:`Pipeline`})]}),(0,X.jsxs)(`label`,{className:`mb-4 flex min-h-11 items-center justify-between gap-3 text-sm text-fg`,children:[`Dual-pass bloom`,(0,X.jsx)(`input`,{type:`checkbox`,checked:n.pipeline,onChange:e=>p({pipeline:e.target.checked}),className:`size-4 accent-fg`})]}),(0,X.jsx)(vu,{label:`Bloom`,value:n.bloom,onChange:e=>p({bloom:e})}),(0,X.jsx)(vu,{label:`Luminance gate`,value:n.threshold,onChange:e=>p({threshold:e})}),(0,X.jsx)(vu,{label:`Parallax`,value:n.parallax,onChange:e=>p({parallax:e})}),(0,X.jsx)(`p`,{className:`mt-3 text-[0.7rem] leading-relaxed text-fg-subtle`,children:r&&!c?`Camera was blocked — pointer still drives inverse shift.`:`Move across the field. Inverse mapping: you go left, light goes right.`})]})]})}function vu({label:e,value:t,onChange:n}){return(0,X.jsxs)(`label`,{className:`mb-3 block`,children:[(0,X.jsxs)(`span`,{className:`mb-1 flex justify-between font-mono text-[0.65rem] text-fg-muted uppercase`,children:[e,(0,X.jsx)(`span`,{className:`tabular-nums text-fg`,children:t.toFixed(2)})]}),(0,X.jsx)(`input`,{type:`range`,min:0,max:1,step:.01,value:t,onChange:e=>n(Number(e.target.value)),className:`h-2 w-full cursor-pointer appearance-none rounded-full bg-bg-subtle accent-fg`})]})}function yu(e,t){let n=e*6.283+t*1.256;return .5+.5*Math.sin(n)}function bu(){let[e,t]=(0,c.useState)(!1),[n,r]=(0,c.useState)(`sovereign`),[i,a]=(0,c.useState)(Lc),[o,s]=(0,c.useState)(!1),[l,u]=(0,c.useState)(!1),[d,f]=(0,c.useState)(!1),[p,m]=(0,c.useState)({motion:.5,depth:.52,fps:60}),h=(0,c.useCallback)(e=>{a(t=>({...t,...e}))},[]);return(0,X.jsxs)(`main`,{className:`relative h-dvh w-full overflow-hidden bg-bg text-fg`,children:[(0,X.jsx)(Hc,{scene:n,params:i,cameraLock:e&&o,onStats:m,onCameraStatus:u}),(0,X.jsx)(_u,{entered:e,scene:n,params:i,cameraLock:o,cameraReady:l,settingsOpen:d,stats:p,onEnter:()=>t(!0),onScene:r,onParams:h,onCameraLock:s,onSettings:f})]})}export{bu as component};